    ...
    return (
        <div className='dashboard-header'>
            ...
            <div id="nav-admin" className="fixed w-full shadow-md top-0 left-0 flex justify-between bg-white p-4 px-4 md:px-6 lg:px-16 items-center z-50" data-aos="bg">
                ...
                <div className="">
                    <ul className="flex cursor-pointer md:gap-4 items-center">
                        <li className="hidden sm:block text-lg font-medium p-2">
                        ...
                        <li onClick={handleDropdown} className="text-lg font-medium hover:bg-sky-200 rounded md:ml-6 p-2">
                            <div className='flex items-center'>
                                <FaUserCircle className="text-2xl sm:mr-3 text-slate-500" />
            ...
            <div id="" className={!nav ?
                ...
                'fixed flex flex-col justify-between transition-all ease-in duration-300 bg-white dark:bg-slate-700  shadow-lg shadow-right md:hidden h-full w-64 pl-5'}>
                ...
                <ul className=" justify-start items-start cursor-pointer gap-2 mt-4">
                    ...
                    <li className="block sm:hidden text-lg p-4 py-3 font-medium border-b-2 border-transparent  ease-in-out duration-500 hover:bg-sky-300 m-2 ml-0 rounded">
                        <Link href="./services" className=" flex flex-row items-center gap-4"><BiBell /><span className="w-28">Notification</span> </Link>
                    </li>
                    <li className="block sm:hidden text-lg p-4 py-3 font-medium border-b-2 border-transparent  ease-in-out duration-500 hover:bg-sky-300 m-2 ml-0 rounded">
                        <Link href="./services" className=" flex flex-row items-center gap-4"><DarkmodeDS /></Link>
                    </li>
                    <li className="text-lg p-4 py-3 font-medium border-b-2 border-transparent  ease-in-out duration-500 hover:bg-sky-300 m-2 ml-0 rounded">
