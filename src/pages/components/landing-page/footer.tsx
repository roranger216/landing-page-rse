...
const Footer = () => {
	return (
    <div id="footer" className="left-0  bg-neutral-800 dark:bg-gray-800">
      <div className="flex max-[850px]:flex-wrap max-sm:p-3 flex-row md:justify-around justify-start items-start p-10 md:p-20">
          ...
          <ul>
            ...
            <div className="flex flex-row flex-wrap gap-2 pb-5">
              <img
                ...
                className="cursor-pointer transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 w-4 sm:w-7 ..."
              ></img>
              <img
        ...
        <div className="p-5 max-sm:w-40 md:w-56">
          <ul>
            <p className="text-gray-100 font-bold text-sm sm:text-2xl pb-4">
              Services
            </p>
