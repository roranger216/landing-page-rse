...
<<<<<<< HEAD
        ...
        <div className={classNames(scrollPosition > 0 ? 'shadow-md' : 'shadow-none py-6', 'fixed w-full top-0 left-0 flex justify-between bg-white p-4 px-8 md:px-6 lg:px-16 items-center z-50')} data-aos="bg">
            ...
            <div className="pr-0 xl:pr-16">
                ...
                <div className={!nav ? 'hidden' : 'fixed ease-in-out duration-300 md:hidden'}>
