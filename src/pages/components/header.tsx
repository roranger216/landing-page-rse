...
const Header = () => {
  ...
  return (
    <div id="nav-holder" className={classNames(scrollPosition > 0 ? 'shadow-md' : 'shadow-none py-6', 'fixed w-full top-0 left-0 flex justify-between bg-white p-4 px-8 md:px-6 lg:px-16 items-center z-50')}>
        ...
        <ul className="hidden md:flex md:gap-4 lg:gap-12 cursor-pointer">
          ...
          <li className="mt-2">
            <Linked
              ...
              className="text-lg px-4 py-1 font-medium border-2 border-sky-600 text-black hover:bg-sky-600 hover:text-white rounded-md ease-in duration-200"
            >
              Sign In
            </Linked>
          </li>
