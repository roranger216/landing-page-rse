...
const Contactus = () => {
    return (
        ...
        <form className="mx-auto">
            ...
            <div className="my-3 mx-auto">
                <input type="number" className="w-full mt-2 p-4 outline-none border-none rounded-lg" placeholder="Enter Your Password"/> 
            </div>
    
            <div className="my-3 mx-auto">
                 <textarea className="w-full h-36 mt-2 p-4 outline-none border-none rounded-lg" placeholder="Type Message..."></textarea>
            </div>
            <button className="w-full p-3 mt-2 Ibg-[#846add] text-lg text-white rounded-lg outline-none border-none font-bold tracking-wide transition-all hover:bg-[#252525]"> 
                Submit
            </button>
        </form>
       </div>
